...
parser.add_argument('--min-silence-length', '-m', type=float, default=2.,
                    help='The minimum length of silence at which a split may occur [seconds]. Defaults to 2 seconds.')
...
sample_rate, samples = input_data = load_wav(filename=input_filename)
